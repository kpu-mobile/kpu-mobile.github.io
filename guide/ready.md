...
# 拉取演示源码
git clone -b example https://github.com/kpu-mobile/web.git
```
...
# 拉取演示源码
git clone -b example https://gitee.com/kpu-mobile/web.git
```
...
::: warning 注意
- 在 [package.json](https://github.com/kpu-admin/basic/blob/main/package.json#L4-L6) 文件中有限制 node 要求版本，建议使用最新 LTS 版本。
